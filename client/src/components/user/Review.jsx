...
const Review = () => {
  ...
  const getAllReviews = async () => {
    try {
      const data = await axios.get(`${baseURL}/api/v1/review`, {
        ...
        <>
          <div className="w-screen flex flex-col justify-center items-center">
            ...
            <p className="w-96 md:w-1/2 text-center text-[#5A5A5A]">
              Here are some of our graduates and students who explain what it's
              like to learn with us, and why they chose computer courses.
            </p>
          </div>
                  ...
                  <div key={index} className="flex p-10 items-center gap-4">
                    <div className="flex-grow">
                      ...
                      <h5 className="text-sm">
                        <span className="text-[#fd0c0c] capitalize">
                          {review.name}
                        </span>{" "}
                        - India
                      </h5>
                    ...
                    <div className="flex-shrink-0 mt-2">
                      <img
                        src={
                          review.reviewImage ? review.reviewImage : ReviewImage
                        }
                        alt={review.name}
