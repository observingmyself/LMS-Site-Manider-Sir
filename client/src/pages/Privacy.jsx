    ...
    <>
      <div className="bg-[#EEF4FC] py-4  mt-24">
        ...
        <p className="text-center mt-4 flex items-center justify-center gap-2">
          ...
          <box-icon name="fast-forward" flip="vertical"></box-icon>Privacy
          Policy
        </p>
      </div>
      {/* instructions */}
      <div className="p-5 my-5 md:my-20 gap-8 md:mx-20 lg:mx-30">
        <div className="mb-5">
          ...
          <h3 className=" text-base mb-2 text-gray-700 md:text-lg">
            ...
            protects any information that you give ADVANCE COMPUTER CENTRE when
            you use this website.
          </h3>
          <h3 className=" text-base  mb-2 text-gray-700 md:text-lg">
            ADVANCE COMPUTER CENTRE is committed to ensuring that your privacy
          ...
          <h3 className="mb-5 text-base text-gray-700 md:text-lg">
            ADVANCE COMPUTER CENTRE may change this policy from time to time by
        ...
        <div>
          <ul className="mb-5">
            <li className="text-base font-bold mb-5 text-gray-800">
              We may collect the following information:
            </li>
            <li className="text-sm md:text-base mb-5 text-gray-700">
              Name and job title
            </li>
            <li className="text-sm md:text-base mb-5 text-gray-700">
            ...
            <li className="text-sm md:text-base font-bold mb-5 text-gray-800">
