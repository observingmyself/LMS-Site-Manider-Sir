...
const EditProfilePage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if (!formData.email.trim() || !formData.userName.trim() || !formData.mobileNo.trim()) return toast.error("These fields are required")
        ...
        <div className="min-h-screen mt-12 px-4 flex items-center justify-center bg-gray-100">
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
                ...
                <div className="relative items-center flex justify-center">
                    ...
                    <label htmlFor="profileImg" className="cursor-pointer">
                        <form onSubmit={handleImageUpdate}>
                            ...
                            >
                                {!profileImg && (
                                    <span className="text-gray-500 text-sm"><img src={user?.profileImg} className='h-32' alt="" /></span>
                                )}
                            ...
                            <button type='submit' className='my-2 px-2 py-2 bg-red-500 rounded-lg text-white hover:bg-red-600 transition-all duration-200'>{isLoading ? 'Loading...' : 'Update Image'}</button>
                        </form>
                        {/* Hidden Input */}
                        <input
                            id="profileImg"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Mobile Number Field */}
                    <div>
                        <label htmlFor="mobileNo" className="block text-gray-700 font-medium mb-1">
                            Mobile Number
                        </label>
                        <input
                            type="tel"
